...
- The Hermes JSON-RPC client speaks `/api/ws` on port 9119 against a test double or a live helper. This environment has no running Hermes dashboard, so pairing stays in waiting / helper-not-running and demo messages stay queued.
